...
const LABEL = 'PROS';
const HEADLINE = 'RINGAN & CEPAT';
const SUBTITLE = 'Nyaman dipakai lama, pairing instan';
const CLAMP = { extrapolateLeft: 'clamp' as const, extrapolateRight: 'clamp' as const };

const ProsDesign: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ fontFamily: FONT_BODY, background: COLORS.d900, opacity: fadeOut }}>
      ...
      >
        <Check size={28} color={COLORS.signal} strokeWidth={3} />
        <span style={{ fontFamily: FONT_MONO, fontSize: 26, fontWeight: 700, letterSpacing: 4, color: COLORS.signal }}>
          {LABEL}
        </span>
      </div>
